    ...
    <>
      <section className="bg-[url(/images/instamainbg.jpg)] relative z-20 h-[1030px] md:h-screen text-white bg-cover bg-center justify-items-center  bg-white  ">
        ...
        <BackgroundBeamsWithCollision >
          ...
          <Image src="/images/instamainbg.png" className=" absolute top-20 xl:h-[400px] xl:w-[400px] w-[100px] h-[100px] left-0 xl:-left-24 rotate-12 select-none" height={400} width={400} alt="LogoMain"/>
          <Image src="/images/instamainbg.png" className=" absolute top-20 xl:h-[400px] xl:w-[400px] w-[100px] h-[100px] right-0 xl:-right-24 -rotate-12 select-none" height={400} width={400} alt="LogoMain"/>
          <h1 className=" text-6xl text-center relative pt-10 md:pt-20 font-bold"> <span className="bg-gradient-to-r to-[#240055] from-[#D00096] text-transparent bg-clip-text">Instagram </span>video Downloader</h1>
